...
//			}
		//3. Example: DELETE all records whose campany_id is 104
...
//			}
		...
		/*
		 1. Step: Create a POJO Class
		 		...
		 		b) Create constructors without parameters
		 		c) Create constructors with all parameters
		 		d) Create getters and setters
		 		e) Create tiString() method
