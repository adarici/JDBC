...
public class JavaExecuteQuery01 {
	/*
	 1) In DDL (Data De4finition Language: CREATE TABLE, DROP TABLE, ALTER TABLE), we use execute()
	 2) execute () returns boolean
	 3) when you use execute () in DDL, it returns false
	  	 when you use execute () in DDL, it returns ResultSet
	  	  when you use execute () in DDL, it returns true
	 */
